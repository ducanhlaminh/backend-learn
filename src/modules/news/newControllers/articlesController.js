...
const articlesController = {
        guest: {
                get_articles: {
                        getHotCategoryController: asyncHandler(
                                async (req, res) => {
                                        let hotArticlesCate =
                        ...
                        getHotSubCategoryController: asyncHandler(
                                async (req, res) => {
                                        const box =
                                                await articlesService.guest.get.getHotBoxSubCategoryService(
                                                        req.query.slug_crc
                        ...
                        getByTitleControllers: asyncHandler(
                                async (req, res) => {
                        ...
                        getByPublishAtController: asyncHandler(
                                async (req, res) => {
                                        const news =
                                                await articlesService.guest.get.getByPublishAt(
                                                        req.query
                                                );
                                        res.status(200).json({
                                                newArticleCate: news,
                        ...
                        getBoxCategoryControllers: asyncHandler(
                                async (req, res) => {
                                        const box =
                                                await articlesService.guest.get.getHotBoxSubCategoryService(
                                                        req.query?.slug_crc
        ...
        admin: {
                get_articles: {
                        getAllController: async (req, res) => {
                                console.log("okkk");
                                const response =
                                        await articlesService.admin.get.getAllService(
                                                {
                                                        ...req.query,
                                                        role_id: req?.user
                                                                ?.role,
