            ...
            try {
                  ...
                  if (created) {
                        ...
                        let info = await transporter.sendMail({
                              from: '"Đăng ký tài khoản thành công" <ducanhlaminh@gmail.com>', // sender address
                              to: data.email, // list of receivers
                              subject: "Test send email ✔", // Subject line
                              text: "Hello world?", // plain text body
                              html: ` <div><b>Tài khoản này đã được đăng ký thành công</b></div>
                    <span
                        >Vui lòng truy cập vào link sau đây để đăng nhập vào hệ thống và sau khi đăng nhập lần đầu hệ thống sẽ tạo mật khẩu mặc định
                        :</span
                    >
                    <div>
      ...
      loginGoogleService: asyncHandler(async (user, profile) => {
            if (user) {
                  ...
                  if (!checkUser.password) {
                        ...
                        2;
                        let info = await transporter.sendMail({
                              from: '"Password account" <ducanhlaminh@gmail.com>', // sender address
